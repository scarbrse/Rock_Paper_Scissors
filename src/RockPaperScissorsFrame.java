...
public class RockPaperScissorsFrame extends JFrame {
    ...
    private void CreateTitlePnl(){
        ...
        game = new ImageIcon("src/game.png");
    ...
    private void CreateChoicePnl(){
        ...
        rockIco = new ImageIcon("src/rockIco.png");
        ...
        paperIco = new ImageIcon("src/paperIco.png");
        ...
        scissorIco = new ImageIcon("src/scissorIco.png");
        ...
        quitIco = new ImageIcon("src/quitIco.png");
    ...
    private void CreateWinCntPnl(){
        ...
        userIco = new ImageIcon("src/userIco.png");
        ...
        tieIco = new ImageIcon("src/tieIco.png");
        ...
        aiIco = new ImageIcon("src/aiIco.png");
